<x-admin-layout>
    ...
    <div class="container" style="max-width: 900px; margin: 0 auto; padding: 20px;">
        <h1 style="font-size: 1.5rem; font-weight: 700; color: #1f2937; margin-bottom: 1.5rem;">Edit Tematik: {{ $tematik->nama_tematik }}</h1>
        ...
        <div class="form-card">
            <form action="{{ route('admin.tematik.update', $tematik->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" 
                           name="nama_tematik" 
                           id="nama_tematik" 
                           value="{{ old('nama_tematik', $tematik->nama_tematik) }}"
                           class="form-input" 
                ...
                <div style="display: flex; align-items: center; justify-content: flex-end; border-top: 1px solid #e5e7eb; padding-top: 1.5rem; margin-top: 1.5rem;">
                    ...
                    <button type="submit" class="btn-submit">
                        <i class="fa-solid fa-save" style="margin-right: 0.5rem;"></i> Perbarui Tematik
                    </button>
                </div>
            </form>
        </div>
