<x-admin-layout>
    ...
    <div class="container" style="max-width: 900px; margin: 0 auto; padding: 20px;">
        <h1 style="font-size: 1.5rem; font-weight: 700; color: #1f2937; margin-bottom: 1.5rem;">Tambah Purchase Order Baru</h1>
            ...
            <form action="{{ route('admin.po.store') }}" method="POST">
                ...
                <div style="display: flex; align-items: center; justify-content: flex-end; border-top: 1px solid #e5e7eb; padding-top: 1.5rem; margin-top: 1.5rem;">
                    ...
                    <button type="submit" class="btn-submit">
                        <i class="fa-solid fa-save" style="margin-right: 0.5rem;"></i> Simpan PO
                    </button>
                </div>
            </form>
        </div>
